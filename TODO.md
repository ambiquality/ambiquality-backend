...
All four phases done 2026-06-12 (PR #51 merged, tests.yml CI green; chapter
`testovani.tex` committed in MrLogEN/BP main as 3fb69a1 and pushed). Current
numbers: xUnit 577/577, newman 75 req / 113 assertions.
